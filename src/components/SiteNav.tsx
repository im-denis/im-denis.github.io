...
export function SiteNav() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-background/80 backdrop-blur-xl border-b border-border/60">
      <div className="px-6 md:px-12 py-5 md:py-7">
        <div className="mx-auto max-w-[1600px] flex items-center justify-between relative">
          {/* Logo and Name */}
          <Link to="/#works" className="h-8 md:h-10 flex items-end">
            <img src={logo} alt="D" className="h-full object-contain" />
            <span className="font-script font-bold leading-none [word-spacing:0.1em] text-[rgb(28,66,111)] text-2xl md:text-3xl -ml-0.5">
              enis Simon
            </span>
          </Link>
