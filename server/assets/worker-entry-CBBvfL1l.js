...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-ByVRQHqP.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CocG7-iP.js").then((n2) => n2.r),
...
var ROUTER_BASEPATH = "denis-artist";
var SERVER_FN_BASE = "/denis-artist/_serverFn/";
