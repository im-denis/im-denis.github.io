...
function SiteNav() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-50 bg-background/80 backdrop-blur-xl border-b border-border/60", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-[1600px] px-6 md:px-12 py-5 md:py-7 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "font-display text-xl md:text-2xl tracking-tighter leading-none", children: [
        "DENIS",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: open && /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.nav,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col px-6 py-6 gap-5", children: [
          links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: l.to,
...
function SiteFooter() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "mt-32 border-t border-border/60 bg-secondary/40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-[1600px] px-6 md:px-12 py-16 md:py-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-display text-5xl md:text-7xl lg:text-8xl tracking-tighter leading-[0.9] mb-12", children: [
      "Let's make",
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      "something real."
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-8 text-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono-caps text-xs text-muted-foreground mb-3", children: "Studio" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Munich, Germany" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono-caps text-xs text-muted-foreground mb-3", children: "Contact" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "mailto:info@denissimonart.com", className: "hover:underline underline-offset-4", children: "info@denissimonart.com" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono-caps text-xs text-muted-foreground mb-3", children: "Follow" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://instagram.com", target: "_blank", rel: "noopener noreferrer", className: "block hover:underline underline-offset-4", children: "Instagram" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://www.etsy.com", target: "_blank", rel: "noopener noreferrer", className: "block hover:underline underline-offset-4", children: "Etsy Shop" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono-caps text-xs text-muted-foreground mb-3", children: "Navigate" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "block hover:underline underline-offset-4", children: "Work" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/vita", className: "block hover:underline underline-offset-4", children: "Vita" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/commissions", className: "block hover:underline underline-offset-4", children: "Commissions" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-16 pt-8 border-t border-border/60 flex flex-col md:flex-row justify-between items-start md:items-center gap-2 text-xs font-mono-caps text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "© 2026 Denis Simon. All rights reserved." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Acrylic on canvas — Realism & Nature" })
    ] })
  ] }) });
}
