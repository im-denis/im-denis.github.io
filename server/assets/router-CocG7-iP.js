...
const appCss = "/denis-artist/assets/styles-BKzrmMFZ.css";
...
const Route$3 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Denis Simon" },
      { name: "description", content: "Denis Simon — Realistic Landscapes and Animal Portraits." },
      { name: "author", content: "Denis Simon" },
      { property: "og:title", content: "Denis Simon" },
      { property: "og:description", content: "Denis Simon — Realistic Landscapes and Animal Portraits." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Denis Simon" },
      { name: "twitter:description", content: "Denis Simon — Realistic Landscapes and Animal Portraits." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/184c1880-00f1-4aa5-a4e1-7940b1652ace/id-preview-598ae50a--0a415caf-056c-4e92-8a98-d73be164aa84.lovable.app-1777580847687.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/184c1880-00f1-4aa5-a4e1-7940b1652ace/id-preview-598ae50a--0a415caf-056c-4e92-8a98-d73be164aa84.lovable.app-1777580847687.png" }
    ],
    links: [
      {
        rel: "stylesheet",
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;700;800;900&family=JetBrains+Mono:wght@400;500&display=swap" }
    ]
  }),
...
const $$splitComponentImporter$2 = () => import("./vita-BqFh9ewP.js");
const Route$2 = createFileRoute("/vita")({
  head: () => ({
    meta: [{
      title: "Vita — Denis Simon"
    }, {
      name: "description",
      content: "The biography and artistic journey of painter Denis Simon."
    }, {
      property: "og:title",
      content: "Vita — Denis Simon"
    }, {
...
const $$splitComponentImporter$1 = () => import("./commissions-C4Mc5jlO.js");
const Route$1 = createFileRoute("/commissions")({
  head: () => ({
    meta: [{
      title: "Commissions — Denis Simon"
    }, {
      name: "description",
      content: "Commission a custom acrylic painting — landscape or animal portrait — by Denis Simon."
    }, {
      property: "og:title",
      content: "Commissions — Denis Simon"
    }, {
      property: "og:description",
      content: "Commission a custom acrylic painting — landscape or animal portrait — by Denis Simon."
    }]
...
const $$splitComponentImporter = () => import("./index-DOBL45vn.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Portfolio of Denis Simon — realistic acrylic landscapes and animal portraits."
    }, {
      property: "og:title",
      content: "Denis Simon — Acrylic Realism & Nature"
    }, {
      property: "og:description",
      content: "Portfolio of Denis Simon — realistic acrylic landscapes and animal portraits."
    }]
...
const VitaRoute = Route$2.update({
  id: "/vita",
  path: "/vita",
  getParentRoute: () => Route$3
});
const CommissionsRoute = Route$1.update({
  id: "/commissions",
  path: "/commissions",
  getParentRoute: () => Route$3
});
